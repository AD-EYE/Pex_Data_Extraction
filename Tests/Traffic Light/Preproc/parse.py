...
def get_roads(path='./data/roads.pex'):
    ...
    # The following fonctions are called by get_staticalobject and return the staticalobject type with the right parameters define in staticalobject.py corresponding to the staticalobject id in the input. #
